...
int main() try
{
    ...
    deserialize("../data/mmod_rear_end_vehicle_detector.dat") >> net >> sp;

    matrix<rgb_pixel> img;
    
    load_image(img, "/home/zhida/Documents/Data/testimages/18.jpg");
    // load_image(img, "/home/zhida/Desktop/th.jpeg");
